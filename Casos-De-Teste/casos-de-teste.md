...
Cenário: CT29 - Verificar espaçamento entre os campos do formulário<br>
Dado que o usuário está na tela de cadastro de cursos<br>
Quando o formulário é exibido<br>
Então o espaçamento entre os campos deve ser consistente<br>

Cenário: CT30 - Verificar cor do botão de cadastro<br>
Dado que o usuário está na tela de cadastro de cursos<br>
...
Cenário: CT31 - Verificar botão de exclusão<br>
...
Cenário: CT32 - Verificar estado hover dos botões<br>
...
Cenário: CT33 - Exibir mensagem de erro clara<br>
...
Cenário: CT34 - Abrir a aplicação em outra aba<br>
Dado que existem cursos cadastrados no sistema<br>
